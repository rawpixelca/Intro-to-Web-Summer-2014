		...
		$.ajax({
			...
			success: function(response) {
				response.data.forEach(function(photo) {
					...
					var photoWindow2Content = '';
					photoWindow2Content += '<img class="profile" src="' + photo.user.profile_picture + '">';
					...
					var photoWindow2 = new google.maps.InfoWindow({
						content: photoWindow2Content,
					});
					...
					google.maps.event.addListener(
						...
						function(event) {
							...
							photoWindow2.open(instaMap, photoMarker);
							instaMap.setCenter(event.latLng);
							openPhotoWindow = photoWindow2;
